...
import { X, Plus, Upload, HelpCircle, Lightbulb, Loader2, Shield, CheckCircle } from "lucide-react"
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-100 px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      {processingState.isProcessing ? (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-gray-700">AI is analyzing your image...</span>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {!canConnect && !processingState.isProcessing && uploadedImage && (
                        <Tooltip>
                          <TooltipTrigger asChild>
