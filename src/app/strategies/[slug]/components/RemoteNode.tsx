                                    ...
                                    <div className="relative">
                                        <Input
                                            ...
                                            className={cn(
                                                ...
                                                urlValidation.isValid && "border-green-400 focus:border-green-500 focus:ring-green-500",
                                                websiteUrl && !urlValidation.isValid && "border-red-400 focus:border-red-500 focus:ring-red-500",
                                                urlValidation.warning && "border-yellow-400 focus:border-yellow-500 focus:ring-yellow-500",
                                            )}
                                        ...
                                        <Button
                                            ...
                                            size="sm"
                                            disabled={!urlValidation.isValid || processingState.isProcessing}
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2 text-sm">
                                                {urlValidation.isValid ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <span className="text-red-600">{urlValidation.error || "Invalid URL"}</span>
                                                    </>
                                                )}
                                            </div>
                                            ...
                                            {urlValidation.warning && (
                                                <div className="flex items-start gap-2 text-sm bg-yellow-50 p-2 rounded-lg border border-yellow-200">
                                                    ...
                                                    <span className="text-yellow-700">{urlValidation.warning}</span>
                                                </div>
                                            )}
                                        </div>
                                    )}
                                    ...
                                    <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div className="text-xs text-blue-700">
                                                ...
                                                <div>
                                                    URLs are validated for security. Local networks, suspicious domains, and invalid formats are
                                                    blocked to prevent costly processing.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
